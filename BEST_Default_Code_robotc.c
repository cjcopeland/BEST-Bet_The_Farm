...
int adjustThrottle(int input) {
	...
	if (output > maxPercentThrottle * maxNegThrottle || output < maxPercentThrottle * maxPosThrottle)
...
task main{
	while (true) {	//forever loop
		...
		else if (vexRT[Btn5U] == btnOff)	//else if button 5U is pressed, raise the arm
